...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#1D1D1F] text-white py-16 px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          <div className="lg:col-span-2">
            ...
            >
              <h3 className="text-2xl font-bold mb-4">CMS Trinity Group</h3>
              <p className="text-gray-400 mb-6 leading-relaxed max-w-md">
                Redefining elegance through minimalist design and premium craftsmanship.
        ...
        >
          <p className="text-gray-400 text-sm">
            2026 CMS Trinity Group. All rights reserved.
          </p>
